!(function (e, t) {
    ...
    a = (e, t, s) => {
      ...
      for (; void 0 === l.obj && a.length; )
        (n = `${a[a.length - 1]}.${n}`),
          ...
          (l = r(e, a, Object)),
          l && l.obj && void 0 !== l.obj[`${l.k}.${n}`] && (l.obj = void 0);
      l.obj[`${l.k}.${n}`] = s;
    },
    l = (e, t) => {
  ...
  const c = (t) => (e(t) ? t.replace(/[&<>"'\/]/g, (e) => u[e]) : t);
  const g = [" ", ",", "?", "!", ";"],
    d = new (class {
      constructor(e) {
        (this.capacity = e),
    ...
    emit(e) {
      ...
      if (this.observers[e]) {
        Array.from(this.observers[e].entries()).forEach((e) => {
          let [t, i] = e;
          for (let e = 0; e < i; e++) t(...s);
        });
      }
      if (this.observers["*"]) {
        Array.from(this.observers["*"].entries()).forEach((t) => {
          let [i, o] = t;
          for (let t = 0; t < o; t++) i.apply(i, [e, ...s]);
        });
      }
    }
  }
        ...
        : ((a = [t, s]),
          i &&
            (Array.isArray(i)
              ...
              ? a.push(...i.split(n))
              : a.push(i)));
      const h = l(this.data, a);
      return (
        !h &&
          !s &&
          !i &&
          t.indexOf(".") > -1 &&
          ((t = a[0]), (s = a[1]), (i = a.slice(2).join("."))),
        !h && r && e(i)
          ? f(this.data && this.data[t] && this.data[t][s], i, n)
          : h
      );
    }
    addResource(e, t, s, i) {
  ...
  var S = {
    ...
    handle(e, t, s, i, o) {
      return (
        e.forEach((e) => {
          this.processors[e] && (t = this.processors[e].process(t, s, i, o));
        }),
        t
      );
    },
  ...
  class L extends x {
    ...
    extractFromKey(t, s) {
      ...
      if (r && !a) {
        ...
        const s = t.split(i);
        (i !== o || (i === o && this.options.ns.indexOf(s[0]) > -1)) &&
          (n = s.shift()),
          (t = s.join(o));
      }
      return e(n) && (n = [n]), { key: t, namespaces: n };
    }
    translate(t, s, i) {
      if (
        ("object" != typeof s &&
      ...
      const o =
        ...
        n =
          void 0 !== s.keySeparator
            ? s.keySeparator
            : this.options.keySeparator,
        { key: r, namespaces: a } = this.extractFromKey(t[t.length - 1], s),
        l = a[a.length - 1],
        h = s.lng || this.language,
        p = s.appendNamespaceToCIMode || this.options.appendNamespaceToCIMode;
      if (h && "cimode" === h.toLowerCase()) {
        if (p) {
          const e = s.nsSeparator || this.options.nsSeparator;
          return o
            ? {
                res: `${l}${e}${r}`,
                usedKey: r,
      ...
      const u = this.resolve(t, s);
      let c = u && u.res;
      const g = (u && u.usedKey) || r,
        d = (u && u.exactUsedKey) || r,
        f = Object.prototype.toString.apply(c),
        m = void 0 !== s.joinArrays ? s.joinArrays : this.options.joinArrays,
        y = !this.i18nFormat || this.i18nFormat.handleAsObject,
        v = !e(c) && "boolean" != typeof c && "number" != typeof c;
      if (
        !(
          y &&
          c &&
        ...
        if (y && e(m) && Array.isArray(c))
          (c = c.join(m)), c && (c = this.extendTranslation(c, t, s, i));
        else {
          let o = !1,
            a = !1;
          const p = void 0 !== s.count && !e(s.count),
            g = L.hasDefaultValue(s),
            d = p ? this.pluralResolver.getSuffix(h, s.count, s) : "",
            f =
              s.ordinal && p
            ...
            y =
              (m && s[`defaultValue${this.options.pluralSeparator}zero`]) ||
              s[`defaultValue${d}`] ||
              s[`defaultValue${f}`] ||
              s.defaultValue;
          !this.isValidLookup(c) && g && ((o = !0), (c = y)),
            this.isValidLookup(c) || ((a = !0), (c = r));
          const v =
              ...
              a
                ? void 0
                : c,
            b = g && y !== c && this.options.updateMissing;
          if (a || o || b) {
            if (
              (this.logger.log(
              ...
              const e = this.resolve(r, { ...s, keySeparator: !1 });
              e &&
                e.res &&
                this.logger.warn(
            ...
            const i = (e, t, i) => {
              ...
              this.options.missingKeyHandler
                ? this.options.missingKeyHandler(e, l, t, o, b, s)
                : this.backendConnector &&
                  this.backendConnector.saveMissing &&
                  this.backendConnector.saveMissing(e, l, t, o, b, s),
                this.emit("missingKey", e, l, t, c);
            };
            this.options.saveMissing &&
              (this.options.saveMissingPlurals && p
                ? e.forEach((e) => {
                    const t = this.pluralResolver.getSuffixes(e, s);
                    m &&
                      ...
                      t.forEach((t) => {
                        i([e], r + t, s[`defaultValue${t}`] || y);
                      });
                  })
                : i(e, r, y));
          }
          (c = this.extendTranslation(c, t, s, u, i)),
            a &&
              c === r &&
        ...
        if (!s.returnObjects && !this.options.returnObjects) {
          ...
          const e = this.options.returnedObjectHandler
            ? this.options.returnedObjectHandler(g, c, { ...s, ns: a })
            : `key '${r} (${this.language})' returned an object instead of string.`;
          return o
            ? ((u.res = e), (u.usedParams = this.getUsedParamsDetails(s)), u)
            : e;
        }
        if (n) {
          ...
          for (const e in c)
            if (Object.prototype.hasOwnProperty.call(c, e)) {
              const o = `${i}${n}${e}`;
              (t[e] = this.translate(o, { ...s, joinArrays: !1, ns: a })),
                t[e] === o && (t[e] = c[e]);
            }
          c = t;
        }
      ...
      return o
        ? ((u.res = c), (u.usedParams = this.getUsedParamsDetails(s)), u)
        : c;
    }
    extendTranslation(t, s, i, o, n) {
      ...
      if (this.i18nFormat && this.i18nFormat.parse)
        ...
        let h = i.replace && !e(i.replace) ? i.replace : i;
        if (
    ...
    resolve(t) {
      ...
      return (
        ...
        t.forEach((t) => {
          ...
          const u = void 0 !== a.count && !e(a.count),
            c =
              u &&
              !a.ordinal &&
              0 === a.count &&
            ...
            this.isValidLookup(s) ||
              ...
              d.forEach((t) => {
                ...
                if (this.i18nFormat && this.i18nFormat.addLookupKeys)
                  this.i18nFormat.addLookupKeys(i, h, t, e, a);
                else {
                  let e;
                  u && (e = this.pluralResolver.getSuffix(t, a.count, a));
                  ...
                  if (
                    (u &&
                      ...
                      a.ordinal &&
                        0 === e.indexOf(o) &&
                        i.push(h + e.replace(o, this.options.pluralSeparator)),
                      c && i.push(h + s)),
                    g)
                  ) {
                    const t = `${h}${this.options.contextSeparator}${a.context}`;
                    i.push(t),
                      u &&
                        (i.push(t + e),
                        a.ordinal &&
                          0 === e.indexOf(o) &&
                          i.push(
                            t + e.replace(o, this.options.pluralSeparator)
                          ),
                        c && i.push(t + s));
                  }
                }
                ...
                for (; (r = i.pop()); )
                  this.isValidLookup(s) ||
                    ((o = r), (s = this.getResource(t, e, r, a)));
              }));
          });
        }),
        { res: s, usedKey: i, exactUsedKey: o, usedLng: n, usedNS: r }
      );
    }
    isValidLookup(e) {
      return !(
  ...
  class N {
      ...
      if (e(t) && t.indexOf("-") > -1) {
        if ("undefined" != typeof Intl && void 0 !== Intl.getCanonicalLocales)
          try {
            ...
            if ((e && this.options.lowerCaseLng && (e = e.toLowerCase()), e))
              return e;
          } catch (e) {}
    ...
    toResolveHierarchy(t, s) {
      const i = this.getFallbackCodes(s || this.options.fallbackLng || [], t),
        o = [],
        n = (e) => {
          e &&
      ...
      (this.languageUtils = e),
        ...
        (this.rules = (() => {
          ...
          return (
            R.forEach((t) => {
              t.lngs.forEach((s) => {
                e[s] = { numbers: t.nr, plurals: C[t.fc] };
              });
            }),
            e
          );
    ...
    getRule(e) {
      ...
      if (this.shouldUseIntlApi())
        try {
          ...
          const n = new Intl.PluralRules(s, { type: i });
    ...
    getSuffixes(e) {
      ...
      return s
        ? this.shouldUseIntlApi()
          ...
          : s.numbers.map((s) => this.getSuffix(e, s, t))
        : [];
    }
    getSuffix(e, t) {
      let s =
  ...
  const I = function (t, s, i) {
      ...
      return (
        !r && n && e(i) && ((r = f(t, i, o)), void 0 === r && (r = f(s, i, o))),
        r
      );
    },
    F = (e) => e.replace(/\$/g, "$$$$");
  class A {
      ...
      return (
        [
          ...
          for (l = 0; (r = i.regex.exec(t)); ) {
            ...
            const h = i.safeValue(a);
            if (
              ((t = t.replace(r[0], h)),
              c
                ? ((i.regex.lastIndex += a.length),
                  (i.regex.lastIndex -= r[0].length))
                : (i.regex.lastIndex = 0),
              l++,
              l >= this.maxReplaces)
            )
    ...
    nest(t, i) {
      ...
      for (; (o = this.nestingRegexp.exec(t)); ) {
        ...
        if (
          ((n = i(l.call(this, o[1].trim(), r), r)), n && o[0] === t && !e(n))
        )
          return n;
        e(n) || (n = s(n)),
          n ||
  ...
  class D {
    constructor() {
      ...
      (this.logger = b.create("formatter")),
        ...
        (this.formats = {
          number: V(
            (e, t) => (s) => new Intl.NumberFormat(e, { ...t }).format(s)
          ),
          currency: V(
            (e, t) => (s) =>
              new Intl.NumberFormat(e, { ...t, style: "currency" }).format(s)
          ),
          datetime: V(
            (e, t) => (s) => new Intl.DateTimeFormat(e, { ...t }).format(s)
          ),
          relativetime: V(
            (e, t) => (s) =>
              new Intl.RelativeTimeFormat(e, { ...t }).format(
                s,
                t.range || "day"
              )
          ),
          list: V((e, t) => (s) => new Intl.ListFormat(e, { ...t }).format(s)),
        }),
        this.init(e);
    }
    init(e) {
  ...
  class z extends x {
    ...
    init() {
      ...
      const n = T();
      (this.options = { ...n, ...this.options, ...K(i) }),
        "v1" !== this.options.compatibilityAPI &&
          (this.options.interpolation = {
            ...n.interpolation,
            ...this.options.interpolation,
      ...
      if (!this.options.isClone) {
        ...
        this.modules.logger
          ...
          this.modules.formatter
            ...
            : "undefined" != typeof Intl && (e = D);
        const t = new N(this.options);
    ...
    getFixedT(t, s, i) {
      ...
      const n = function (e, t) {
        ...
        if ("object" != typeof t) {
          for (
            ...
            a[l - 2] = arguments[l];
          s = o.options.overloadTranslationOptionHandler([e, t].concat(a));
        } else s = { ...t };
        (s.lng = s.lng || n.lng),
          (s.lngs = s.lngs || n.lngs),
          (s.ns = s.ns || n.ns),
          "" !== s.keyPrefix && (s.keyPrefix = s.keyPrefix || i || n.keyPrefix);
        const h = o.options.keySeparator || ".";
        let p;
        return (
          (p =
            s.keyPrefix && Array.isArray(e)
              ? e.map((e) => `${s.keyPrefix}${h}${e}`)
              : s.keyPrefix
              ? `${s.keyPrefix}${h}${e}`
              : e),
          o.t(p, s)
      ...
      return (
        e(t) ? (n.lng = t) : (n.lngs = t), (n.ns = s), (n.keyPrefix = i), n
      );
    }
    t() {
    ...
    dir(e) {
      if (
        ...
        return "rtl";
      const t = (this.services && this.services.languageUtils) || new N(T());
      return [
        "ar",
        "shu",
        "sqr",
    ...
    cloneInstance() {
      ...
      return (
        ...
        s &&
          ((o.store = new k(this.store.data, i)),
          (o.services.resourceStore = o.store)),
        (o.translator = new L(o.services, i)),
  ...
  const H = z.createInstance();
  return (H.createInstance = z.createInstance), H;
});
